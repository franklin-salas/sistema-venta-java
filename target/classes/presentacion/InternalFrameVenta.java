 ...
 * @author lanister
 */
public class InternalFrameVenta extends javax.swing.JInternalFrame implements SelectorInterface {
    ...
    public InternalFrameVenta(JFrame jFmP) {
        initComponents();
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(textIdCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        this.accion = "NUEVO";
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (textIdCliente.getText().length() == 0) {
        ...
        String resp = "";
        resp = this.control.insertar(Integer.parseInt(textIdCliente.getText()), (String) cboTipoComprobante.getSelectedItem(), textSerieComprobante.getText(), textNumeroSerie.getText(), Double.parseDouble(textImpuesto.getText()), Double.parseDouble(textTotal.getText()), modeloDetalle);
        if (resp.equals("OK")) {
    ...
    private void btnSeleccionarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarProveedorActionPerformed
        ...
        DialogSelecionarCliente selectorFrm = new DialogSelecionarCliente(this.contenedor, true);
    ...
    private void textCodigoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textCodigoKeyReleased
        ...
        if (textCodigo.getText().length() > 0) {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                Articulo art = control.obtenerArticuloCodigoVenta(textCodigo.getText());
                if (art == null) {
                    this.mensajeWarning("No existe el Articulo con ese codigo o esta inactivo");
                    return;
                }
    ...
    private void btnVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerActionPerformed
        ...
        if (this.tabla.getSelectedRowCount() == 1) {
            ...
            this.textIdCliente.setText(idProveedor);
            this.textNombreCliente.setText(nombreProveedor);
    ...
    private void calcularTotales() {
        ...
        for (int i = 0; i < count; i++) {
            String textSubTotal = String.valueOf(modeloDetalle.getValueAt(i, 7));
    ...
    private void limpiarFormulario() {
        ...
        this.textNombreCliente.setText("");
    ...
    public void seleccionarObjetoDialog(Object aObjeto, int tipoObjeto) {
        ...
        switch (tipoObjeto) {
            case SelectorInterface.ARTICULO:
                ...
                break;
            case SelectorInterface.CLIENTE:
                Persona cliente = (Persona) aObjeto;
                this.textIdCliente.setText(String.valueOf(cliente.getId()));
                this.textNombreCliente.setText(cliente.getNombre());
                break;
            default:
    ...
    private void obtenerNumero() {
        ...
        textSerieComprobante.setText(serieComprobante);
        if (numComprobante.equals("")){
            textNumeroSerie.setText("");
        }else{
            int num;
            num=Integer.parseInt(numComprobante)+1;
            textNumeroSerie.setText(Integer.toString(num));
        }        
    }
}
