 ...
 * @author frank
 */
public class DialogSelecionarCliente extends javax.swing.JDialog {
   ...
   private final PersonaControl control;
    ...
    public DialogSelecionarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if(this.tabla.getSelectedRowCount()== 1){
          ...
          Persona p =  new Persona(Integer.parseInt(id), nombreAnt);
            this.seleccionarObj.seleccionarObjetoDialog(p,SelectorInterface.CLIENTE);
