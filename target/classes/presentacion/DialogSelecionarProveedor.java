 ...
 * @author frank
 */
public class DialogSelecionarProveedor extends javax.swing.JDialog {
   ...
   private final PersonaControl control;
    ...
    private SelectorInterface seleccionarObj;

    public DialogSelecionarProveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabCrud, javax.swing.GroupLayout.DEFAULT_SIZE, 768, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (this.accion.equals("EDITAR")) {
            ...
            res =this.control.actualizar(Integer.parseInt(id),"Proveedor",textNombre.getText(),this.nombreAnt,(String)cboTipoDocumento.getSelectedItem(),textNumDocumento.getText(),textDireccion.getText(),textTelefono.getText(),textEmail.getText());
            this.tabCrud.setEnabledAt(1, false);
            this.tabCrud.setEnabledAt(0, true);
            this.tabCrud.setSelectedIndex(0);
        } else {

            res=this.control.insertar("Proveedor",textNombre.getText(),(String)cboTipoDocumento.getSelectedItem(),textNumDocumento.getText(),textDireccion.getText(),textTelefono.getText(),textEmail.getText());
    ...
    private void btnSeleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarActionPerformed
        ...
        if(this.tabla.getSelectedRowCount()== 1){
          ...
          Persona p =  new Persona(Integer.parseInt(id), nombreAnt);
            this.seleccionarObj.seleccionarObjetoDialog(p,SelectorInterface.PROVEEDOR);
    ...
    private void paginar(){
        ...
        this.totalRegistros=this.control.totalProveedor();
    ...
    private void listar(String text, boolean paginar) {
        ...
        if (paginar==true){
            tabla.setModel(this.control.listar(text,this.totalPorPagina,this.numPagina,"Proveedor"));
        }else{
            tabla.setModel(this.control.listar(text,this.totalPorPagina,1,"Proveedor"));
        }
        ...
        this.labelTotalRegistros.setText("Mostrando " + this.control.totalMostrados() + " de " + this.control.totalProveedor());

    }

 
    public void seleccionarObjeto (SelectorInterface interf ){
        this.seleccionarObj = interf;
    }
