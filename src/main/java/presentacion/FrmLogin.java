...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, 160, 140));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/city.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 290, 440));
        ...
        jButton2.setBackground(new java.awt.Color(102, 190, 255));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 350, 140, 30));

        jButton3.setBackground(new java.awt.Color(102, 190, 255));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
            ...
            if(textUsuario.getText().length()==0 || textUsuario.getText().length()>50){
        ...
        if(clave.length()==0 || clave.length()>64){
        ...
        String resp=control.login(textUsuario.getText(), clave);
        if (resp.equals("1")){
            this.dispose();
